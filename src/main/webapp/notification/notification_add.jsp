...
<title>通知資料新增 - addNotification.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>通知資料新增 - addNotification.jsp</h3></td><td>
...
<table>
	...
	<tr>
		<td>會員編號：<font color=red><b>*</b></td>
		<td><input type="TEXT" name="memberId" value="<%= (notificationVO==null)? "1" : notificationVO.getMemberId()%>" size="45"/></td>
	</tr>
	<tr>
...
<tr>
	...
	<tr>
		<td>檢舉編號：</td>
		<td><input type="TEXT" name="reportId"   value="<%= (notificationVO==null)?"" : notificationVO.getReportId()%>" size="45"/></td>
	</tr>
		
	<tr>
		<td>員工編號：<font color=red><b>*</b></td>
		<td><input type="TEXT" name="employeeId"   value="<%= (notificationVO==null)? "1001" : notificationVO.getEmployeeId()%>" size="45"/></td>
	</tr>
	
	<tr>
		<td>更新日期：<font color=red><b>*</b></td>
...
<script>
        ...
        $('#f_date1').datetimepicker({
		   ...
		   value: '<%=createdAt%>', // value:   new Date(),
